...
@Component({
  selector: 'app-crypto',
  standalone: true,
  imports: [RouterModule,SharedModule,NgApexchartsModule,NgSelectModule,FormsModule,ReactiveFormsModule],
...
simpleItems:any=[]
  // Selelct2   
  selectedSimpleItem1=['AED']
  simpleItems1:any=[]
  // select3
  selectedSimpleItem2=['BTC']
  simpleItems2:any=[]
  // select 4
  selectedSimpleItem3=['AED']
  simpleItems3:any=[]
ngOnInit(): void {
  this.simpleItems=['BTC','ETH','XRP','NEO','LTC','BSD'];
